...
class TinyImages(torch.utils.data.Dataset):
    ...
    def __init__(self, transform=None, exclude_cifar=True):
        ...
        data_file = open('/media/sunyiyou/ubuntu-hdd1/datasets/TinyImages/tiny_images.bin', "rb")
        ...
        if exclude_cifar:
            self.cifar_idxs = []
            with open('/media/sunyiyou/ubuntu-hdd1/datasets/TinyImages/80mn_cifar_idxs.txt', 'r') as idxs:
                for idx in idxs:
